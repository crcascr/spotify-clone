...
export const VolumeMuted = ({ color }) => (
  <svg
    role="presentation"
    height="16"
    width="16"
...
export const VolumeMedium = ({ color }) => (
  <svg
    role="presentation"
    height="16"
    width="16"
      ...
      <div className="flex flex-row items-center">
        ...
        >
          {volumeMemory.actual === 0 ? (
            <VolumeMuted color="#a7a7a7" />
          ) : volumeMemory.actual < 0.3 ? (
            <VolumeLow color="#a7a7a7" />
          ) : volumeMemory.actual < 0.6 ? (
            <VolumeMedium color="#a7a7a7" />
          ) : (
            <VolumeHigh color="#a7a7a7" />
          )}
        </button>
